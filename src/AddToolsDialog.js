...
const mockServers = [
  { id: 1, name: 'supabase-mcp', tools: 17, selected: true },
...
const mockTools = [
  ...
  { id: 7, name: 'Fetch Message by Thread ID', slug: 'GMAIL_FETCH_MESSAGE_BY_THREAD_ID', server: 'Gmail', selected: true },
  { id: 8, name: 'Reply to Email Thread', slug: 'GMAIL_REPLY_TO_THREAD', server: 'Gmail', selected: true },
  { id: 9, name: 'List Threads', slug: 'GMAIL_LIST_THREADS', server: 'Gmail', selected: true },
  { id: 10, name: 'Modify Label to Email', slug: 'GMAIL_ADD_LABEL_TO_EMAIL', server: 'Gmail', selected: true },
  { id: 11, name: 'Modify Thread Labels', slug: 'GMAIL_MODIFY_THREAD_LABELS', server: 'Gmail', selected: true },
  { id: 12, name: 'List Gmail Labels', slug: 'GMAIL_LIST_LABELS', server: 'Gmail', selected: true },
  { id: 13, name: 'Get People', slug: 'GMAIL_GET_PEOPLE', server: 'Gmail', selected: true },
  { id: 14, name: 'Create Label', slug: 'GMAIL_CREATE_LABEL', server: 'Gmail', selected: true },
